...
from extract_entities import extract_cgpa, get_number, get_email, rm_email, rm_number, get_name, get_skills
...
def process():
    if request.method == 'POST':
        ...
        # Extract CGPA and add a new column 'CGPA'
        dt['CGPA'] = dt['Original'].apply(lambda x: extract_cgpa(x))

        # Filter resumes with CGPA above 8.0
        cgpa_threshold = 8.0
        dt = dt[dt['CGPA'] > cgpa_threshold]
